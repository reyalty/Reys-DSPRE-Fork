...
namespace DSPRE.Editors {
    ...
    void displayScriptFile(ScriptFile.ContainerTypes containerType, ScriptFile currentScriptFile, ListBox navListBox, Scintilla textArea) {
